...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='font_translator_gan', help='chooses which model to use')
        ...
        parser.add_argument('--shuffle_dataset', action='store_true', help='if specified, shuffle the dataset')
